...
const Login = () => {
    ...
    const {singIn,providerLogin,setLoading}= useContext(AuthContext);
	...
	<div className="flex justify-center space-x-4">
		<button onClick={handeleGoogleSignIn} aria-label="Log in with Google" className="p-3 rounded-sm">
		...
		<button onClick={handeleGitHubSignIn} aria-label="Log in with GitHub" className="p-3 rounded-sm">
			<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" className="w-5 h-5 fill-current hover:text-blue-500">
